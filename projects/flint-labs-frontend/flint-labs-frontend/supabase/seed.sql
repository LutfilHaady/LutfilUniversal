...
INSERT INTO equipment (id, equipment_code, name, process_id, supplier_info, is_active) VALUES
  ('a1000001-0000-0000-0000-000000000001'::uuid, 'MA001', '60L Mixer',                'b5c17071-a20f-4ba2-b53e-6dd1b98c1946'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000002'::uuid, 'MA002', '5L Mixer',                 'a971751f-ceec-4738-be6c-8249c0ccf45c'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000003'::uuid, 'MA003', 'Coating Machine - Input',  '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000004'::uuid, 'MA004', 'Coating Machine - Output', '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000005'::uuid, 'MA005', 'Oven Chamber 1',           '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000006'::uuid, 'MA006', 'Oven Chamber 2',           '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000007'::uuid, 'MA007', 'Oven Chamber 3',           '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000008'::uuid, 'MA008', 'Oven Chamber 4',           '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000009'::uuid, 'MA009', 'Oven Chamber 5',           '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000010'::uuid, 'MA010', 'Oven Chamber 6',           '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000011'::uuid, 'MA011', 'Calendering - Input',      'a1ddf202-3fe4-4e7b-b13f-5f7b1515bf71'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000012'::uuid, 'MA012', 'Calendering - Roller',     'a1ddf202-3fe4-4e7b-b13f-5f7b1515bf71'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000013'::uuid, 'MA013', 'Calendering - Output',     'a1ddf202-3fe4-4e7b-b13f-5f7b1515bf71'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000014'::uuid, 'MA014', 'Die Cutting - Input',      '57050fa3-b8b9-421e-9d8a-17ca9793d584'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000015'::uuid, 'MA015', 'Die Cutting - Main',       '57050fa3-b8b9-421e-9d8a-17ca9793d584'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000016'::uuid, 'MA016', 'Slitting',                 '81f4c276-5608-42c9-a42a-068aab14ba38'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000017'::uuid, 'MA017', 'Cutting',                  'c5895fd9-86a4-4324-96fc-dfb505889f80'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000018'::uuid, 'MA018', 'Cell Assembly',            '4f249480-13e2-4f73-853e-df60627f7acd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000019'::uuid, 'MA019', 'Compressor Unit',          '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000020'::uuid, 'MA020', 'Compressor Chiller',       '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000021'::uuid, 'MA021', 'Compressor Tank',          '8c028b13-2407-474b-ac43-93d83912b9dd'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000022'::uuid, 'MA022', 'Water Purification',       'b5c17071-a20f-4ba2-b53e-6dd1b98c1946'::uuid, NULL, true),
  ('a1000001-0000-0000-0000-000000000023'::uuid, 'MA023', 'Vacuum Unit',              '4f249480-13e2-4f73-853e-df60627f7acd'::uuid, NULL, true)
