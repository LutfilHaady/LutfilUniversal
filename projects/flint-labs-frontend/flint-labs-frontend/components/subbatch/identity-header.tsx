...
import { IconUser, IconMachines, IconCalendar, IconClipboard, IconPlus, IconCheck, IconPause, IconRotate, IconTrash, IconClose, IconShield, IconQR } from '@/components/icons';
              ...
              <>
                ...
                {(role === 'Engineer' || role === 'Admin') && STATUS_CHANGE_BUTTONS.filter(b => b.showFrom.includes(currentStatus)).map(btn => (
                  <button
                    ...
                    className="h-9 px-3 rounded-md border bg-transparent text-[12px] flex items-center justify-center gap-1.5 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                    style={{
