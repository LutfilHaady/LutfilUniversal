  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await supabase.from('batch_status_changes').insert({
        ...
        reason:      'Raw material intake — initial registration',
      });
      ...
      const createdBatch: MainBatch = {
        ...
        material:         selectedMaterial
          ? { name: selectedMaterial.name, code: selectedMaterial.code }
          : null,
        ...
        <div className="w-[480px] bg-[#0e0e0e] border-l border-[#2a2a2a] flex flex-col shadow-2xl">
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-6 px-6 py-10">
            ...
            <div className="bg-white p-5 rounded-xl shadow-lg">
              <QRCode value={successBatch.batchNumber} size={180} />
            </div>
            <div className="text-[11.5px] text-[#5a5a5a] text-center">
              Print or photograph this QR code and attach it to the batch container.
            </div>
          </div>
