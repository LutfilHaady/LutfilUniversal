"""
Quick visualization generator using only price and event data
This runs much faster than loading the full transaction dataset
"""
import zipfile
import io
import pandas as pd
...
print("=" * 80)
print("Generating visualizations from price and event data...")
print("(Skipping transaction data for speed)\n")
...
# ============================================================================
# QUESTION 1.1: PRICE DEPEGGING
# ============================================================================
if 'USTC' in price_data:
    print("\n" + "=" * 80)
    print("Generating Q1.1: Price Depegging Visualization")
    print("=" * 80)
    ...
    plt.close()
    print("  Saved: q1_onset_price_depegging.png")

# ============================================================================
# QUESTION 3.3: SYSTEM DESIGN FAILURE (Death Spiral)
# ============================================================================
if 'USTC' in price_data and 'WLUNA' in price_data:
    print("\n" + "=" * 80)
    print("Generating Q3.3: System Design Failure (Death Spiral)")
    print("=" * 80)
    ...
    print(f"  USTC-WLUNA Correlation: {correlation:.4f}")
    ...
    plt.close()
    print("  Saved: q3_system_design_failure.png")

# ============================================================================
# QUESTION 1.4: SENTIMENT ANALYSIS
# ============================================================================
if not event_data.empty:
    ...
    if len(ustc_events) > 0:
        ...
        plt.close()
        print("  Saved: q1_sentiment_events.png")

print("\n" + "=" * 80)
print("QUICK VISUALIZATIONS COMPLETE!")
print("=" * 80)
...
print("\nNote: Full analysis with transaction data is running in the background.")
print("Additional visualizations will be generated when that completes.")
