...
export default function GenealogyImpactMap({
  ...
  if (!data || (data.ancestors.length === 0 && data.descendants.length === 0)) {
    return (
      <div className="rounded-xl border flex items-center justify-center py-12" style={{ borderColor: '#2a2a2a', background: '#111111' }}>
        <div className="text-[13px] text-[#888888]">No genealogy found for this batch.</div>
      </div>
    );
  }
