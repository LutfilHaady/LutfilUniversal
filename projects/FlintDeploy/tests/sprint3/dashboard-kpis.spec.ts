  ...
  test('QC Pass Rate shows 80% and KPI card is present', async ({ page }) => {
    ...
    await page.route(`**${SB}/rest/v1/qc_check_results*`, (route) =>
      route.fulfill({
        ...
        body: JSON.stringify([
          { id: 'q1', passed: true,  qc_check_definitions: { acceptance_criteria_text: '20-25' } },
          { id: 'q2', passed: true,  qc_check_definitions: { acceptance_criteria_text: '20-25' } },
          { id: 'q3', passed: true,  qc_check_definitions: { acceptance_criteria_text: 'No visible lumps' } },
          { id: 'q4', passed: true,  qc_check_definitions: { acceptance_criteria_text: 'No visible lumps' } },
          { id: 'q5', passed: false, qc_check_definitions: { acceptance_criteria_text: 'No visible lumps' } },
        ]),
      })
    )
    ...
    await page.route(`**${SB}/rest/v1/qc_check_results*`, (route) =>
      route.fulfill({
        ...
        body: JSON.stringify([
          ...
          { id: 'q2', passed: true,  qc_check_definitions: { acceptance_criteria_text: '20-25' } },
          { id: 'q3', passed: true,  qc_check_definitions: { acceptance_criteria_text: 'No visible lumps' } },
          { id: 'q4', passed: false, qc_check_definitions: { acceptance_criteria_text: 'No visible lumps' } },
          { id: 'q5', passed: false, qc_check_definitions: { acceptance_criteria_text: 'No visible lumps' } },
        ]),
      })
    )
